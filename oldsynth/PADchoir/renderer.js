...
//
// `size` is table size in samples. Must be power of 2.
//
function padsynth(sampleRate, frequencies, bandWidth, rnd, size) {
...
function makeFrequencyShiftChoirFrequencies(sampleRate, params, rnd) {
  ...
  var spec = renderWaveTable(
    params.baseFreq, params.basefunc, params.basefuncP1, params.modType, params.modP1,
    params.modP2, params.modP3, params.filtType, params.filtCutoff, params.filtQ,
    params.harmonicShift, params.adaptiveHarmonics, params.adaptBaseFreq,
    params.adaptPower, params.overtone);
...
onmessage = (event) => {
  ...
  var sound = padsynth(
    sampleRate, frequencies, params.bandWidth, rnd,
    params.tableSize * params.overSampling);
