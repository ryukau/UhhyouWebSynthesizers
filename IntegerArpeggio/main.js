...
const scales = {
  ...
  resonance: new parameter.LinearScale(0, 1, true),
...
const param = {
  ...
  useFilter: new parameter.Parameter(0, scales.boolean),
...
const ui = {
  ...
  removeDirectCurrent: new widget.ToggleButtonLine(
    detailRender, ["Leave Direct Current", "Remove Direct Current"],
  ...
  useFilter: new widget.ToggleButtonLine(
    detailFilter, ["Filter is Disabled", "Filter is Enabled"], param.useFilter, render),
