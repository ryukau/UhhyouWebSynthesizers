...
const ui = {
  ...
  noisePulseRatio: new widget.NumberInput(detailOsc, "Noise/Pulse", param.noisePulseRatio, render),
  ...
  lowpassCutoffBaseHz:
    new widget.NumberInput(detailLP, "Cutoff Base [Hz]", param.lowpassCutoffBaseHz, render),
  ...
  highpassCutoffBaseHz:
    new widget.NumberInput(detailHP, "Cutoff Base [Hz]", param.highpassCutoffBaseHz, render),
